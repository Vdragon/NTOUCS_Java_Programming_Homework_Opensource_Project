/** @file GasMeterTest.java
    @brief 1-3 作業 GasMeter 物件類別測試程式
...
public class GasMeterTest {
	...
	public static void main(String[] args){
		System.out.println("1-3 作業 GasMeter 類別測試程式");
		...
		System.out.println("---------------------------------------------------------");
		GasMeter.readAndEvaluateMilesPerGallons();
		return;
	}
}
