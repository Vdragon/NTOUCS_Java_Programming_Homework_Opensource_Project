/** 
	@file CrapsSimulationTest.java
	@brief 2-2 作業 CrapsSimulation 類別測試程式
...
public class CrapsSimulationTest {
	...
	public static void main(String[] args){
		System.out.println("2-2 作業 CrapsSimulation 類別測試程式");
